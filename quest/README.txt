...
Video Link: http://www.youtube.com/watch?v=wu_XrmWvtM4
...
4- Create a folder called rc on your C drive and move the rainingchain folder there.
5- Open command prompt. (Search for command with window start search bar)
6- Move to the rainingchain directory using cd.. and cd (folder_name)
